...
#ifdef WINBT
	dev->tty.io_devctlext = winbt_devctl;
...
__SRCVERSION( "$URL: http://svn/product/tags/internal/bsp/nto650/ti-j5-evm/1.0.0/latest/hardware/devc/seromap/init.c $ $Rev: 504859 $" );
