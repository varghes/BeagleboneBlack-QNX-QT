...
#define	OMAP3_MMCHS_CON			0x02C	// Configuration register
	...
	#define	CON_MIT				(1 <<  6)	// Disable command timeout for response
...
__SRCVERSION( "$URL: http://svn/product/tags/restricted/bsp/nto650/ti-j5-evm/latest/src/hardware/devb/mmcsd/chipsets/sim_omap3.h $ $Rev: 568644 $" )
