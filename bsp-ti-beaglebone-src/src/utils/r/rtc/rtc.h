...
extern int init_tps659xx(struct chip_loc *chip, char *argv[]);
extern int get_tps659xx(struct tm *tm, int cent_reg);
extern int set_tps659xx(struct tm *tm, int cent_reg);
...
extern int init_am335xrtc(struct chip_loc *chip, char *argv[]);
extern int get_am335xrtc(struct tm *tm, int cent_reg);
extern int set_am335xrtc(struct tm *tm, int cent_reg);
...
__SRCVERSION( "$URL: http://svn/product/tags/restricted/bsp/nto650/ti-am3517-evm/latest/src/utils/r/rtc/rtc.h $ $Rev: 390374 $" )
