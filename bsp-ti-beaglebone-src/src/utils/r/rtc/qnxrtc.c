...
#define NET_CLOCK_IDX 	0
    ...
    { "tps659xx",		init_tps659xx, get_tps659xx, set_tps659xx },
	...
	{ "am335xrtc",     init_am335xrtc, get_am335xrtc, set_am335xrtc },
#endif
	{ NULL,			NULL }
};
...
__SRCVERSION( "$URL: http://svn/product/tags/restricted/bsp/nto650/ti-am3517-evm/latest/src/utils/r/rtc/qnxrtc.c $ $Rev: 390374 $" );
