...
int omap_set_hw_cursor(disp_adapter_t *adapter, int dispno, uint8_t * bmp0,
	...
	if (o_ctx->hcursor != 1) {
		DEBUG_MSG("hw_cursor disabled in config file");
		return -1;
	}
...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto641/ti-omap3530-beagle/latest/src/hardware/devg/omap35xx/hcursor.c $ $Rev: 308279 $" );
